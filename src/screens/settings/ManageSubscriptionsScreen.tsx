...
export const ManageSubscriptionsScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
          ...
          {loading ? (
            ...
            <>
                ...
                <View style={{ paddingHorizontal: 16, marginBottom: 8 }}>
                  <View style={styles.sectionHeader}>
                    <View>
                      ...
                      <Text style={{ fontSize: 12, color: theme.colors.textSecondary }}>Manage plan</Text>
                    </View>
              ...
              <Animated.View entering={FadeInDown.duration(400).delay(500)} style={{ paddingHorizontal: 16, marginBottom: 16 }}>
                ...
                <GlassCard
                  onPress={() => { haptics.medium(); handleAction("Upgrade Plan"); }}
                  style={{ marginBottom: 10, padding: 14 }}
                >
                  <View style={styles.spaceBetween}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 12 }}>
                        <Text style={{ fontSize: 15, fontWeight: '600', color: theme.colors.text }}>Upgrade Plan</Text>
