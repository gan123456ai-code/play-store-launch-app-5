...
const privacyOptionsData = Array.from({ length: 8 }, (_, i) => ({
  id: String(i + 1),
  title: `Privacy Option ${i + 1}`,
  subtitle: `Control your privacy`,
  description: `Privacy ${i + 1}. This includes comprehensive details about pricing, availability, features, amenities, and user reviews. Each item has been carefully curated to provide the best experience for our premium users.`,
  icon: ['🛡️', '🔒', '👁️'][i % 3],
  price: 0 + (i * 500),
  ...
  category: ['Data', 'Sharing', 'Visibility'][i % 3],
  amount: 0 + (i * 500),
  imageEmoji: ['🛡️', '🔒', '👁️'][i % 3],
  details: {
...
export const PrivacySettingsScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
  ...
  const filters = ['all', 'data', 'sharing', 'visibility'];
      ...
      >
        ...
        {loading ? (
          ...
          <View style={{ paddingHorizontal: 16 }}>
            ...
            {privacyOptionsData.map((item, index) => (
