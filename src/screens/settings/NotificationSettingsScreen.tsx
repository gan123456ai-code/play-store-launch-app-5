...
const notifSettingsData = Array.from({ length: 10 }, (_, i) => ({
  id: String(i + 1),
  title: `Notification ${i + 1}`,
  subtitle: `Control notifications`,
  description: `Setting ${i + 1}. This includes comprehensive details about pricing, availability, features, amenities, and user reviews. Each item has been carefully curated to provide the best experience for our premium users.`,
  icon: ['🔔', '📧', '📱'][i % 3],
  price: 0 + (i * 500),
...
export const NotificationSettingsScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
  ...
  const filters = ['all', 'push', 'email', 'sms'];
      ...
      >
        ...
        {loading ? (
          ...
          <View style={{ paddingHorizontal: 16 }}>
            ...
            {notifSettingsData.map((item, index) => (
