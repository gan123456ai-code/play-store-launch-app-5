...
const languagesData = Array.from({ length: 10 }, (_, i) => ({
  id: String(i + 1),
  title: `Language ${i + 1}`,
  subtitle: `Select your preferred language`,
  description: `Language ${i + 1}. This includes comprehensive details about pricing, availability, features, amenities, and user reviews. Each item has been carefully curated to provide the best experience for our premium users.`,
  icon: ['🇮🇳', '🇺🇸', '🇪🇸', '🇫🇷'][i % 4],
  price: 0 + (i * 500),
  ...
  category: ['Popular', 'Indian', 'International'][i % 3],
  amount: 0 + (i * 500),
  imageEmoji: ['🇮🇳', '🇺🇸', '🇪🇸', '🇫🇷'][i % 4],
  details: {
...
export const LanguageSettingsScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
  ...
  const filters = ['all', 'popular', 'indian', 'international'];
