...
const section0Data = Array.from({ length: 8 }, (_, idx) => ({
  id: String(idx + 1),
  title: `Referral ${idx + 1}`,
  subtitle: `Your referral records`,
  description: `This is a detailed description for referral ${idx + 1}. It provides comprehensive information about features, pricing, availability, user ratings, and all other relevant details that premium users need to make informed decisions about their choice.`,
  icon: ['👤', '👩', '👨'][idx % 3],
  value: `₹${(500 + idx * 500).toLocaleString()}`,
  rating: (3.5 + (idx % 15) / 10).toFixed(1),
  reviews: 50 + idx * 30,
  status: ['available', 'limited', 'popular', 'premium'][idx % 4],
  discount: Math.floor(Math.random() * 30 + 5),
  tags: ['Completed', 'Pending', 'Expired'],
  features: ['₹500 earned', 'Pending'],
...
export const ReferEarnScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
          ...
          {loading ? (
            ...
            <>
                ...
                <GlassCard style={{ marginHorizontal: 16, marginBottom: 16, padding: 16 }} animated={false}>
                  ...
                  <View style={[styles.infoRow, { borderBottomColor: theme.colors.divider }]}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 10 }}>
                        <Text style={[styles.infoLabel, { color: theme.colors.textSecondary }]}>Your Referral Code</Text>
                        <Text style={[styles.infoValue, { color: theme.colors.text }]}>TRAVEL500</Text>
                      </View>
                    </View>
                  ...
                  <View style={[styles.infoRow, { borderBottomColor: theme.colors.divider }]}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 10 }}>
                        <Text style={[styles.infoLabel, { color: theme.colors.textSecondary }]}>Successful Referrals</Text>
                        <Text style={[styles.infoValue, { color: theme.colors.text }]}>12 friends</Text>
                      </View>
                    </View>
                    <TouchableOpacity onPress={() => { haptics.light(); }}>
                      <Ionicons name="chevron-forward" size={18} color={theme.colors.textTertiary} />
                  ...
                  <View style={[styles.infoRow, { borderBottomColor: theme.colors.divider }]}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 10 }}>
                        <Text style={[styles.infoLabel, { color: theme.colors.textSecondary }]}>Total Earnings</Text>
                        <Text style={[styles.infoValue, { color: theme.colors.text }]}>₹6,000</Text>
                      </View>
                    </View>
                    <TouchableOpacity onPress={() => { haptics.light(); }}>
                      <Ionicons name="chevron-forward" size={18} color={theme.colors.textTertiary} />
                  ...
                  <View style={[styles.infoRow, { borderBottomColor: theme.colors.divider }]}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 10 }}>
                        <Text style={[styles.infoLabel, { color: theme.colors.textSecondary }]}>Pending Rewards</Text>
                        <Text style={[styles.infoValue, { color: theme.colors.text }]}>₹1,500</Text>
                      </View>
                    </View>
                    <TouchableOpacity onPress={() => { haptics.light(); }}>
                      <Ionicons name="chevron-forward" size={18} color={theme.colors.textTertiary} />
              ...
              <Animated.View entering={FadeInDown.duration(400).delay(300)}>
                <View style={{ paddingHorizontal: 16, marginBottom: 8 }}>
                  <View style={styles.sectionHeader}>
                    <View>
                      <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>📜 Referral History</Text>
                      <Text style={{ fontSize: 12, color: theme.colors.textSecondary }}>Track referrals</Text>
                    </View>
                    <TouchableOpacity onPress={() => haptics.light()}>
              ...
              <Animated.View entering={FadeInDown.duration(400).delay(500)} style={{ paddingHorizontal: 16, marginBottom: 16 }}>
                ...
                <GlassCard
                  onPress={() => { haptics.medium(); handleAction("Share Referral Link"); }}
                  style={{ marginBottom: 10, padding: 14 }}
                >
                  <View style={styles.spaceBetween}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 12 }}>
                        <Text style={{ fontSize: 15, fontWeight: '600', color: theme.colors.text }}>Share Referral Link</Text>
                ...
                <GlassCard
                  onPress={() => { haptics.medium(); handleAction("Copy Referral Code"); }}
                  style={{ marginBottom: 10, padding: 14 }}
                >
                  <View style={styles.spaceBetween}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 12 }}>
                        <Text style={{ fontSize: 15, fontWeight: '600', color: theme.colors.text }}>Copy Referral Code</Text>
                        <Text style={{ fontSize: 12, color: theme.colors.textSecondary }}></Text>
                      </View>
                    </View>
                    <Ionicons name="chevron-forward" size={20} color={theme.colors.textTertiary} />
