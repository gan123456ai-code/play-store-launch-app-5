...
const securityItemsData = Array.from({ length: 8 }, (_, i) => ({
  id: String(i + 1),
  title: `Security ${i + 1}`,
  ...
  category: ['Password', 'Biometric', '2FA'][i % 3],
  amount: 0 + (i * 500),
  imageEmoji: ['🔒', '📱', '🔐', '👆'][i % 4],
  details: {
...
export const BankSecuritySettingsScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
  ...
  const filters = ['all', 'password', 'biometric', '2fa'];
      ...
      >
        ...
        {loading ? (
          ...
          <View style={{ paddingHorizontal: 16 }}>
            ...
            {securityItemsData.map((item, index) => (
