...
const themesData = Array.from({ length: 6 }, (_, i) => ({
  id: String(i + 1),
  title: `Theme ${i + 1}`,
  subtitle: `App appearance theme`,
  description: `Theme ${i + 1}. This includes comprehensive details about pricing, availability, features, amenities, and user reviews. Each item has been carefully curated to provide the best experience for our premium users.`,
  icon: ['🌙', '☀️', '🎨', '💜'][i % 4],
  price: 0 + (i * 500),
...
export const AppearanceSettingsScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
  ...
  const filters = ['all', 'mode', 'color', 'font'];
