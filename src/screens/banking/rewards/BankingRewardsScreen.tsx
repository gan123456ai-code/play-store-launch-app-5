...
const section0Items = Array.from({ length: 10 }, (_, idx) => ({
  ...
  trending: idx % 4 === 0,
  details: {
    line1: `Key detail: Premium quality reward with verified certifications`,
...
const section1Items = Array.from({ length: 12 }, (_, idx) => ({
  id: `item_${idx}`,
  title: `Cashback Offer ${idx + 1}`,
  subtitle: `Get money back`,
  description: `Detailed description for cashback offer ${idx + 1}. This premium item offers exceptional quality and value. Features include top-rated service, verified reviews from thousands of users, competitive pricing with exclusive member discounts, and 24/7 customer support. Available across multiple locations with easy booking and instant confirmation. Rated ${(4 + Math.random()).toFixed(1)} stars by over ${100 + idx * 50} verified users.`,
  icon: ['💰', '💵', '🤑'][idx % 3],
  amount: 50 + idx * 25,
  rating: Number((3.8 + (idx % 12) / 10).toFixed(1)),
  reviews: 50 + idx * 25,
  status: ['active', 'pending', 'completed', 'featured'][idx % 4],
  tags: ['5% Back', '10% Back', 'Flat ₹100'].slice(0, 2 + idx % 2),
  ...
  trending: idx % 4 === 0,
  details: {
    line1: `Key detail: Premium quality cashback offer with verified certifications`,
    line2: `Additional info: Available 24/7 with instant confirmation and support`,
    line3: `Note: Member exclusive pricing with loyalty points on every transaction`,
    stat1: { label: 'Rating', value: `${(4 + Math.random()).toFixed(1)}★` },
    stat2: { label: 'Users', value: `${(100 + idx * 50).toLocaleString()}` },
...
const section2Items = Array.from({ length: 15 }, (_, idx) => ({
  id: `item_${idx}`,
  title: `Partner Deal ${idx + 1}`,
  subtitle: `Exclusive partner offer`,
  description: `Detailed description for partner deal ${idx + 1}. This premium item offers exceptional quality and value. Features include top-rated service, verified reviews from thousands of users, competitive pricing with exclusive member discounts, and 24/7 customer support. Available across multiple locations with easy booking and instant confirmation. Rated ${(4 + Math.random()).toFixed(1)} stars by over ${100 + idx * 50} verified users.`,
  icon: ['🤝', '🏪', '🛍️'][idx % 3],
  amount: 200 + idx * 100,
  rating: Number((3.8 + (idx % 12) / 10).toFixed(1)),
  reviews: 50 + idx * 25,
  status: ['active', 'pending', 'completed', 'featured'][idx % 4],
  tags: ['Amazon', 'Flipkart', 'Swiggy'].slice(0, 2 + idx % 2),
  ...
  trending: idx % 4 === 0,
  details: {
    line1: `Key detail: Premium quality partner deal with verified certifications`,
    line2: `Additional info: Available 24/7 with instant confirmation and support`,
    line3: `Note: Member exclusive pricing with loyalty points on every transaction`,
    stat1: { label: 'Rating', value: `${(4 + Math.random()).toFixed(1)}★` },
    stat2: { label: 'Users', value: `${(100 + idx * 50).toLocaleString()}` },
...
export const BankingRewardsScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
  ...
  const tabs = [{"label":"Rewards","icon":"🎁"},{"label":"Cashback","icon":"💰"},{"label":"Partners","icon":"🤝"}];
  const sortOptions = ['default', 'price_low', 'price_high', 'rating', 'popular', 'newest'];

  return (
    <GradientBackground>
      <PremiumHeader title="Rewards Hub" subtitle="🏆 Premium Experience" onBack={() => navigation.goBack()} transparent />
                ...
                <>
                  ...
                  <Animated.View entering={FadeInDown.duration(400).delay(100)}>
                    ...
                    >
                      ...
                      <Text style={styles.bannerSubtitle}>12,450 points available</Text>
                  ...
                  <View style={{ paddingHorizontal: 16, marginTop: 16 }}>
                    <View style={styles.sectionHeader}>
                      <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>🎁 Active Rewards</Text>
              ...
              {selectedTab === 1 && (
                <>
                  ...
                  <Animated.View entering={FadeInDown.duration(400).delay(100)}>
                    ...
                    >
                      <Text style={styles.bannerEmoji}>💰</Text>
                      <Text style={styles.bannerTitle}>Cashback Festival</Text>
                      <Text style={styles.bannerSubtitle}>Earn up to 20% cashback</Text>
                      <View style={styles.bannerStats}>
                        <View style={styles.bannerStat}>
                  ...
                  <View style={{ paddingHorizontal: 16, marginTop: 16 }}>
                    <View style={styles.sectionHeader}>
                      <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>💰 Cashback Offers</Text>
              ...
              {selectedTab === 2 && (
                <>
                  ...
                  <Animated.View entering={FadeInDown.duration(400).delay(100)}>
                    ...
                    >
                      <Text style={styles.bannerEmoji}>🤝</Text>
                      <Text style={styles.bannerTitle}>Partner Marketplace</Text>
                      <Text style={styles.bannerSubtitle}>100+ brands with exclusive deals</Text>
                      <View style={styles.bannerStats}>
                        <View style={styles.bannerStat}>
                          <Text style={styles.bannerStatValue}>15+</Text>
                          <Text style={styles.bannerStatLabel}>Options</Text>
                        </View>
                        <View style={styles.bannerStat}>
                          <Text style={styles.bannerStatValue}>4.5★</Text>
                  ...
                  <View style={{ paddingHorizontal: 16, marginTop: 16 }}>
                    <View style={styles.sectionHeader}>
                      <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>🤝 Partner Offers</Text>
