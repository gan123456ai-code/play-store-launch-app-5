...
const section0Data = Array.from({ length: 8 }, (_, idx) => ({
  id: String(idx + 1),
  title: `Plan ${idx + 1}`,
  subtitle: `High-speed internet plan`,
  ...
  icon: ['🌐', '📶', '🚀'][idx % 3],
  value: `₹${(499 + idx * 200).toLocaleString()}`,
  rating: (3.5 + (idx % 15) / 10).toFixed(1),
  reviews: 50 + idx * 30,
  status: ['available', 'limited', 'popular', 'premium'][idx % 4],
  discount: Math.floor(Math.random() * 30 + 5),
  tags: ['100 Mbps', '200 Mbps', '500 Mbps'],
  features: ['Unlimited', 'No FUP'],
...
export const BroadbandBillScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
        ...
        >
          ...
          {loading ? (
            ...
            <>
              ...
              {/* Broadband Plans Items */}
              <Animated.View entering={FadeInDown.duration(400).delay(300)}>
                <View style={{ paddingHorizontal: 16, marginBottom: 8 }}>
                  <View style={styles.sectionHeader}>
                    <View>
                      <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>🌐 Broadband Plans</Text>
                      <Text style={{ fontSize: 12, color: theme.colors.textSecondary }}>Upgrade your plan</Text>
                    </View>
