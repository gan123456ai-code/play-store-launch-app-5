...
export const ElectricityBillScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
        ...
        >
          ...
          {loading ? (
            ...
            <>
                ...
                <GlassCard style={{ marginHorizontal: 16, marginBottom: 16, padding: 16 }} animated={false}>
                  ...
                  <View style={[styles.infoRow, { borderBottomColor: theme.colors.divider }]}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 10 }}>
                        <Text style={[styles.infoLabel, { color: theme.colors.textSecondary }]}>Dec 2024</Text>
                        <Text style={[styles.infoValue, { color: theme.colors.text }]}>₹2,450 • Paid</Text>
                      </View>
                    </View>
                  ...
                  <View style={[styles.infoRow, { borderBottomColor: theme.colors.divider }]}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 10 }}>
                        <Text style={[styles.infoLabel, { color: theme.colors.textSecondary }]}>Nov 2024</Text>
                        <Text style={[styles.infoValue, { color: theme.colors.text }]}>₹2,120 • Paid</Text>
                      </View>
                    </View>
                    <TouchableOpacity onPress={() => { haptics.light(); }}>
                      <Ionicons name="chevron-forward" size={18} color={theme.colors.textTertiary} />
                  ...
                  <View style={[styles.infoRow, { borderBottomColor: theme.colors.divider }]}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 10 }}>
                        <Text style={[styles.infoLabel, { color: theme.colors.textSecondary }]}>Oct 2024</Text>
                        <Text style={[styles.infoValue, { color: theme.colors.text }]}>₹1,890 • Paid</Text>
                      </View>
                    </View>
                    <TouchableOpacity onPress={() => { haptics.light(); }}>
                      <Ionicons name="chevron-forward" size={18} color={theme.colors.textTertiary} />
              ...
              {/* Electricity Providers Items */}
              <Animated.View entering={FadeInDown.duration(400).delay(300)}>
                <View style={{ paddingHorizontal: 16, marginBottom: 8 }}>
                  <View style={styles.sectionHeader}>
                    <View>
                      <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>⚡ Electricity Providers</Text>
                      <Text style={{ fontSize: 12, color: theme.colors.textSecondary }}>Available providers</Text>
                    </View>
                    <TouchableOpacity onPress={() => haptics.light()}>
                  ...
                  <View style={styles.spaceBetween}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 12 }}>
                        <Text style={{ fontSize: 15, fontWeight: '600', color: theme.colors.text }}>Pay Current Bill</Text>
