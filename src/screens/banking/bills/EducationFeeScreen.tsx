...
const section0Data = Array.from({ length: 5 }, (_, idx) => ({
  id: String(idx + 1),
  title: `Fee ${idx + 1}`,
  subtitle: `Education fee component`,
  description: `This is a detailed description for fee ${idx + 1}. It provides comprehensive information about features, pricing, availability, user ratings, and all other relevant details that premium users need to make informed decisions about their choice.`,
  icon: ['🎓', '📚', '🏫'][idx % 3],
  ...
  tags: ['Tuition', 'Hostel', 'Lab'],
  features: ['EMI Available'],
...
export const EducationFeeScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
              ...
              <Animated.View entering={FadeInDown.duration(400).delay(200)}>
                <GlassCard style={{ marginHorizontal: 16, marginBottom: 16, padding: 16 }} animated={false}>
                  ...
                  <View style={styles.formGroup}>
                    <Text style={[styles.formLabel, { color: theme.colors.textSecondary }]}>Institution</Text>
                  ...
                  <View style={styles.formGroup}>
                    <Text style={[styles.formLabel, { color: theme.colors.textSecondary }]}>Student ID</Text>
                ...
                <View style={{ paddingHorizontal: 16, marginBottom: 8 }}>
                  <View style={styles.sectionHeader}>
                    <View>
                      ...
                      <Text style={{ fontSize: 12, color: theme.colors.textSecondary }}>Fee details</Text>
                    </View>
                  ...
                  <View style={styles.spaceBetween}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 12 }}>
                        <Text style={{ fontSize: 15, fontWeight: '600', color: theme.colors.text }}>Pay Fee</Text>
