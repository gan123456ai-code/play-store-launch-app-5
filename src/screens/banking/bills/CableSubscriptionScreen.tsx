...
const section0Data = Array.from({ length: 8 }, (_, idx) => ({
  id: String(idx + 1),
  title: `Subscription ${idx + 1}`,
  subtitle: `Streaming & cable subscription`,
  description: `This is a detailed description for subscription ${idx + 1}. It provides comprehensive information about features, pricing, availability, user ratings, and all other relevant details that premium users need to make informed decisions about their choice.`,
  icon: ['📺', '🎬', '🎵', '📰'][idx % 4],
  value: `₹${(149 + idx * 100).toLocaleString()}`,
  rating: (3.5 + (idx % 15) / 10).toFixed(1),
  reviews: 50 + idx * 30,
  status: ['available', 'limited', 'popular', 'premium'][idx % 4],
  discount: Math.floor(Math.random() * 30 + 5),
  tags: ['Netflix', 'Prime', 'Hotstar', 'Spotify'],
  features: ['Monthly', 'Annual'],
...
export const CableSubscriptionScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
        ...
        >
          ...
          {loading ? (
            ...
            <>
              ...
              {/* Active Subscriptions Items */}
              <Animated.View entering={FadeInDown.duration(400).delay(300)}>
                <View style={{ paddingHorizontal: 16, marginBottom: 8 }}>
                  <View style={styles.sectionHeader}>
                    <View>
                      <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>📺 Active Subscriptions</Text>
                      <Text style={{ fontSize: 12, color: theme.colors.textSecondary }}>Manage subscriptions</Text>
                    </View>
                  ...
                  <View style={styles.spaceBetween}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 12 }}>
                        <Text style={{ fontSize: 15, fontWeight: '600', color: theme.colors.text }}>Renew All</Text>
