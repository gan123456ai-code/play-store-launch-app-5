...
const billInfoItems = [
  { id: '0', title: 'Consumer Name', subtitle: 'Rahul Sharma', icon: '👤', color: '#6366F1', value: '' },
  { id: '1', title: 'Bill Amount', subtitle: '₹2,450', icon: '💰', color: '#EF4444', value: '' },
  { id: '2', title: 'Due Date', subtitle: '15 Jan 2025', icon: '📅', color: '#F59E0B', value: '' },
  { id: '3', title: 'Bill Period', subtitle: 'Dec 2024', icon: '📊', color: '#10B981', value: '' },
];


export const BillDetailsScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
  ...
  const tabs = [{ id: 'billInfo', label: 'Bill Info' }];
      ...
      >
        ...
        <Animated.View entering={FadeInDown.duration(600).delay(100)}>
          <SearchBar
            ...
            placeholder="Search bill details..."
            showFilter
        ...
        <Animated.View entering={FadeInDown.duration(600).delay(200)}>
          <View style={styles.sectionHeader}>
            <View>
              <Text style={[styles.sectionTitle, { color: theme.colors.text, fontSize: 18 }]}>📌 Bill Info</Text>
