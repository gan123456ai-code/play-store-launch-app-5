...
export const GasBillScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
              ...
              <Animated.View entering={FadeInDown.duration(400).delay(300)}>
                <View style={{ paddingHorizontal: 16, marginBottom: 8 }}>
                  <View style={styles.sectionHeader}>
                    <View>
                      <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>🔥 Gas Providers</Text>
