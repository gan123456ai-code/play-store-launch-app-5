...
const dthPlansData = Array.from({ length: 8 }, (_, i) => ({
  id: String(i + 1),
  title: `DTH Plan ${i + 1}`,
  subtitle: `Channels and validity`,
  description: `DTH plan ${i + 1}. This includes comprehensive details about pricing, availability, features, amenities, and user reviews. Each item has been carefully curated to provide the best experience for our premium users.`,
  icon: ['📡', '📺'][i % 2],
  price: 199 + (i * 100),
  originalPrice: 1199 + (i * 100),
  rating: (3.5 + (i % 15) / 10).toFixed(1),
  reviews: 50 + i * 30,
  tags: ['Popular', 'HD', 'Sports'],
  features: ['200+ Channels', 'HD', 'Recording'],
...
export const DTHRechargeScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
  ...
  const filters = ['all', 'basic', 'hd', 'premium'];
