...
const providersData = Array.from({ length: 10 }, (_, i) => ({
  id: String(i + 1),
  title: `Provider ${i + 1}`,
  subtitle: `Pay your bill here`,
  description: `Provider ${i + 1}. This includes comprehensive details about pricing, availability, features, amenities, and user reviews. Each item has been carefully curated to provide the best experience for our premium users.`,
  icon: ['⚡', '💧', '🔥', '📱'][i % 4],
  price: 0 + (i * 500),
...
export const BillProvidersScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
      ...
      >
        ...
        <Animated.View entering={FadeInDown.duration(600).delay(200)}>
          <View style={styles.sectionHeader}>
            <Text style={[styles.sectionTitle, { color: theme.colors.text, fontSize: 18 }]}>🔥 All Select Provider</Text>
          </View>
          {loading ? (
                ...
                <Animated.View key={item.id} entering={FadeInDown.duration(400).delay(index * 50)}>
                  <GlassCard
                    onPress={() => {
                      ...
                      navigation.navigate('EnterBillAccount', { itemId: item.id, item });
                    }}
