...
const section0Data = Array.from({ length: 6 }, (_, idx) => ({
  ...
  description: `This is a detailed description for policy ${idx + 1}. It provides comprehensive information about features, pricing, availability, user ratings, and all other relevant details that premium users need to make informed decisions about their choice.`,
  icon: ['🛡️', '🏥', '🚗', '🏠'][idx % 4],
  value: `₹${(2000 + idx * 3000).toLocaleString()}`,
  rating: (3.5 + (idx % 15) / 10).toFixed(1),
  reviews: 50 + idx * 30,
  status: ['available', 'limited', 'popular', 'premium'][idx % 4],
  discount: Math.floor(Math.random() * 30 + 5),
  tags: ['Health', 'Motor', 'Home', 'Life'],
  features: ['Annual', 'Monthly'],
  gradient: ['#6366F1', '#8B5CF6'],
  date: `2025-01-${String(10 + idx).padStart(2, '0')}`,
  time: `${6 + idx % 12}:${idx % 2 === 0 ? '00' : '30'}`,
  amount: 2000 + idx * 3000,
...
export const InsurancePremiumScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
                ...
                <GlassCard style={{ marginHorizontal: 16, marginBottom: 16, padding: 16 }} animated={false}>
                  ...
                  <View style={[styles.infoRow, { borderBottomColor: theme.colors.divider }]}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 10 }}>
                        <Text style={[styles.infoLabel, { color: theme.colors.textSecondary }]}>Health Insurance</Text>
                        <Text style={[styles.infoValue, { color: theme.colors.text }]}>₹12,500 due 15 Jan</Text>
                      </View>
                    </View>
                  ...
                  <View style={[styles.infoRow, { borderBottomColor: theme.colors.divider }]}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 10 }}>
                        <Text style={[styles.infoLabel, { color: theme.colors.textSecondary }]}>Motor Insurance</Text>
                        <Text style={[styles.infoValue, { color: theme.colors.text }]}>₹8,200 due 28 Jan</Text>
                      </View>
                    </View>
                    <TouchableOpacity onPress={() => { haptics.light(); }}>
                      <Ionicons name="chevron-forward" size={18} color={theme.colors.textTertiary} />
              ...
              <Animated.View entering={FadeInDown.duration(400).delay(300)}>
                <View style={{ paddingHorizontal: 16, marginBottom: 8 }}>
                  <View style={styles.sectionHeader}>
                    <View>
                      <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>🛡️ Your Policies</Text>
                      <Text style={{ fontSize: 12, color: theme.colors.textSecondary }}>Manage policies</Text>
                    </View>
                    <TouchableOpacity onPress={() => haptics.light()}>
                  ...
                  <View style={styles.spaceBetween}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 12 }}>
                        <Text style={{ fontSize: 15, fontWeight: '600', color: theme.colors.text }}>Pay Premium</Text>
