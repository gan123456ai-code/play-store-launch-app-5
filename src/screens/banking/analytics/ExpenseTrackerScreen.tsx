...
const card1Data = {
  ...
  change: '31.5%',
  changePositive: true,
  subtitle: 'Of ₹1,00,000 monthly budget',
  icon: '🎯',
...
const chart0Data = Array.from({ length: 7 }, (_, idx) => ({
  label: ['Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat', 'Sun'][idx % 12],
  value: 500 + Math.floor(Math.random() * 5000),
  previousValue: 500 + Math.floor(Math.random() * 5000),
...
const list0Data = Array.from({ length: 20 }, (_, idx) => ({
  id: String(idx + 1),
  title: `Expense ${idx + 1}`,
  subtitle: `Recent spending entry`,
  description: `This is a comprehensive description for expense ${idx + 1}. It contains all relevant details about pricing, features, availability, reviews, and everything else that premium users need to make informed decisions. Our platform provides the best experience with top-notch quality and reliability. Each item is carefully curated for maximum value and satisfaction.`,
  icon: ['🍔', '🛒', '🚗', '📱', '🎬'][idx % 5],
  value: '₹' + (50 + idx * 200).toLocaleString(),
  amount: 50 + idx * 200,
  ...
  tags: ['Food', 'Shopping', 'Transport'],
  features: ['Card', 'UPI', 'Cash'],
  gradient: ['#6366F1', '#8B5CF6'],
  date: `2025-01-${String(10 + idx).padStart(2, '0')}`,
  time: `${6 + idx % 12}:${idx % 2 === 0 ? '00' : '30'} ${idx % 2 === 0 ? 'AM' : 'PM'}`,
  category: ['Food', 'Shopping', 'Transport', 'Entertainment'][idx % 4],
...
export const ExpenseTrackerScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
          ...
          <>
            ...
            <Animated.View entering={FadeInDown.duration(400).delay(160)}>
              <GlassCard style={{ marginHorizontal: 16, marginBottom: 16, padding: 16 }} animated={false}>
                <Text style={{ fontSize: 16, fontWeight: '700', color: theme.colors.text, marginBottom: 12 }}>Daily Spending</Text>
                {/* Visual Chart Bars */}
              ...
              <View style={{ paddingHorizontal: 16, marginBottom: 8 }}>
                <View style={styles.sectionHeader}>
                  <View>
                    ...
                    <Text style={{ fontSize: 12, color: theme.colors.textSecondary, marginTop: 2 }}>Track every rupee</Text>
                  </View>
            ...
            <Animated.View entering={FadeInDown.duration(400).delay(320)} style={{ paddingHorizontal: 16, marginBottom: 16 }}>
              ...
              <View style={styles.actionsGrid}>
                ...
                >
                  ...
                  <Text style={[styles.actionLabel, { color: theme.colors.text }]}>Add</Text>
                  <Text style={{ fontSize: 10, color: theme.colors.textTertiary, textAlign: 'center' }}>Expense</Text>
                </TouchableOpacity>
                ...
                >
                  ...
                  <Text style={[styles.actionLabel, { color: theme.colors.text }]}>Charts</Text>
                  <Text style={{ fontSize: 10, color: theme.colors.textTertiary, textAlign: 'center' }}>Visual</Text>
                </TouchableOpacity>
                ...
                >
                  ...
                  <Text style={[styles.actionLabel, { color: theme.colors.text }]}>Tags</Text>
                  <Text style={{ fontSize: 10, color: theme.colors.textTertiary, textAlign: 'center' }}>Manage</Text>
                </TouchableOpacity>
