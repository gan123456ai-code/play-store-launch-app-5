...
const card0Data = {
  ...
  change: '+5%',
  changePositive: true,
  subtitle: 'Monthly income from all sources',
  icon: '📥',
...
const card1Data = {
  ...
  subtitle: 'Monthly expenses across categories',
  icon: '📤',
...
const card2Data = {
  ...
  change: '+15%',
  changePositive: true,
  subtitle: 'Your savings this month',
  icon: '💰',
...
const chart0Data = Array.from({ length: 12 }, (_, idx) => ({
  ...
  previousValue: 20000 + Math.floor(Math.random() * 80000),
  color: ['#10B981', '#EF4444'][idx % 2],
  percentage: Math.floor(Math.random() * 100),
}));



const list0Data = Array.from({ length: 5 }, (_, idx) => ({
  id: String(idx + 1),
  title: `Source ${idx + 1}`,
  subtitle: `Income stream`,
  description: `This is a comprehensive description for source ${idx + 1}. It contains all relevant details about pricing, features, availability, reviews, and everything else that premium users need to make informed decisions. Our platform provides the best experience with top-notch quality and reliability. Each item is carefully curated for maximum value and satisfaction.`,
  icon: ['💼', '🏦', '📈', '🏠', '💰'][idx % 5],
  value: '₹' + (5000 + idx * 10000).toLocaleString(),
  amount: 5000 + idx * 10000,
...
export const CashFlowScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
          ...
          <>
            ...
            <Animated.View entering={FadeInDown.duration(400).delay(240)}>
              <GlassCard style={{ marginHorizontal: 16, marginBottom: 16, padding: 16 }} animated={false}>
                <Text style={{ fontSize: 16, fontWeight: '700', color: theme.colors.text, marginBottom: 12 }}>Monthly Cash Flow</Text>
                {/* Visual Chart Bars */}
              ...
              <View style={{ paddingHorizontal: 16, marginBottom: 8 }}>
                <View style={styles.sectionHeader}>
                  <View>
                    ...
                    <Text style={{ fontSize: 12, color: theme.colors.textSecondary, marginTop: 2 }}>Your earnings</Text>
                  </View>
