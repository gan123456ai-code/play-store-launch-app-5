...
const card0Data = {
  ...
  change: 'FY 2024-25',
  changePositive: true,
  subtitle: 'Based on current income & deductions',
  icon: '🧾',
  gradient: ['#EF4444', '#F87171'],
  stats: [
    { label: 'Income', value: '₹15L', icon: '💰' },
    { label: 'Deductions', value: '₹2.5L', icon: '🛡️' },
    { label: 'Net Tax', value: '₹2.18L', icon: '🧾' },
  ],
};
...
const card1Data = {
  ...
  change: 'Section 80C',
  changePositive: true,
  subtitle: 'Through 80C, 80D, HRA deductions',
  icon: '🛡️',
...
const chart0Data = Array.from({ length: 6 }, (_, idx) => ({
  label: ['80C', '80D', 'HRA', '80E', '80G', 'Others'][idx % 12],
  value: 10000 + Math.floor(Math.random() * 50000),
  previousValue: 10000 + Math.floor(Math.random() * 50000),
  color: ['#6366F1', '#EC4899', '#10B981', '#F59E0B', '#8B5CF6', '#06B6D4'][idx % 6],
...
const list0Data = Array.from({ length: 8 }, (_, idx) => ({
  id: String(idx + 1),
  title: `Deduction ${idx + 1}`,
  subtitle: `Available tax deduction`,
  description: `This is a comprehensive description for deduction ${idx + 1}. It contains all relevant details about pricing, features, availability, reviews, and everything else that premium users need to make informed decisions. Our platform provides the best experience with top-notch quality and reliability. Each item is carefully curated for maximum value and satisfaction.`,
  icon: ['🛡️', '🏥', '🏠', '📚', '🙏'][idx % 5],
  value: '₹' + (10000 + idx * 25000).toLocaleString(),
  amount: 10000 + idx * 25000,
  ...
  tags: ['80C', '80D', 'HRA', '80E'],
  features: ['₹1.5L Limit', 'No Limit'],
  gradient: ['#6366F1', '#8B5CF6'],
  date: `2025-01-${String(10 + idx).padStart(2, '0')}`,
  time: `${6 + idx % 12}:${idx % 2 === 0 ? '00' : '30'} ${idx % 2 === 0 ? 'AM' : 'PM'}`,
  category: ['Insurance', 'Investment', 'HRA', 'Education'][idx % 4],
...
export const TaxPlannerScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
          ...
          <>
            ...
            <Animated.View entering={FadeInDown.duration(400).delay(160)}>
              <GlassCard style={{ marginHorizontal: 16, marginBottom: 16, padding: 16 }} animated={false}>
                <Text style={{ fontSize: 16, fontWeight: '700', color: theme.colors.text, marginBottom: 12 }}>Tax Breakdown</Text>
                {/* Visual Chart Bars */}
            ...
            <Animated.View entering={FadeInDown.duration(400).delay(240)}>
              <View style={{ paddingHorizontal: 16, marginBottom: 8 }}>
                <View style={styles.sectionHeader}>
                  <View>
                    <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>🛡️ Tax Deductions</Text>
                    <Text style={{ fontSize: 12, color: theme.colors.textSecondary, marginTop: 2 }}>Maximize your savings</Text>
                  </View>
            ...
            {/* Quick Actions */}
            <Animated.View entering={FadeInDown.duration(400).delay(320)} style={{ paddingHorizontal: 16, marginBottom: 16 }}>
              ...
              <View style={styles.actionsGrid}>
                ...
                >
                  ...
                  <Text style={[styles.actionLabel, { color: theme.colors.text }]}>Calculate</Text>
                  <Text style={{ fontSize: 10, color: theme.colors.textTertiary, textAlign: 'center' }}>Tax</Text>
                </TouchableOpacity>
                ...
                >
                  ...
                  <Text style={[styles.actionLabel, { color: theme.colors.text }]}>File ITR</Text>
                  <Text style={{ fontSize: 10, color: theme.colors.textTertiary, textAlign: 'center' }}>Online</Text>
                </TouchableOpacity>
                ...
                >
                  ...
                  <Text style={{ fontSize: 10, color: theme.colors.textTertiary, textAlign: 'center' }}>Save tax</Text>
                </TouchableOpacity>
