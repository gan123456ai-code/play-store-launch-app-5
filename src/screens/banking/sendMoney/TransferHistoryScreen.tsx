...
const transferHistoryData = Array.from({ length: 25 }, (_, i) => ({
  id: String(i + 1),
  title: `Transfer ${i + 1}`,
  subtitle: `Money transfer record`,
  ...
  category: ['All', 'Sent', 'Received'][i % 3],
  amount: 100 + (i * 500),
  imageEmoji: ['↗️', '↙️', '💰'][i % 3],
  details: {
...
export const TransferHistoryScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
  ...
  const filters = ['all', 'all', 'sent', 'received'];
      ...
      >
        ...
        {loading ? (
          ...
          <View style={{ paddingHorizontal: 16 }}>
            ...
            {transferHistoryData.map((item, index) => (
