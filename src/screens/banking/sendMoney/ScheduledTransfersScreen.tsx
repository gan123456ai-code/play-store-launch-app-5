...
const scheduledData = Array.from({ length: 5 }, (_, i) => ({
  id: String(i + 1),
  title: `Scheduled Transfer ${i + 1}`,
  subtitle: `Recurring transfer`,
  description: `Scheduled ${i + 1}. This includes comprehensive details about pricing, availability, features, amenities, and user reviews. Each item has been carefully curated to provide the best experience for our premium users.`,
  icon: ['📅', '🔄', '💰'][i % 3],
  price: 1000 + (i * 500),
...
export const ScheduledTransfersScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
