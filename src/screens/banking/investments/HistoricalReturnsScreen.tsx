...
const returnsDataData = Array.from({ length: 12 }, (_, i) => ({
  id: String(i + 1),
  title: `Month ${i + 1}`,
  subtitle: `Monthly returns`,
  description: `Returns ${i + 1}. This includes comprehensive details about pricing, availability, features, amenities, and user reviews. Each item has been carefully curated to provide the best experience for our premium users.`,
  icon: ['📈', '📉'][i % 2],
  price: 1000 + (i * 500),
  ...
  category: ['Monthly', 'Quarterly', 'Yearly'][i % 3],
  amount: 1000 + (i * 500),
  imageEmoji: ['📈', '📉'][i % 2],
  details: {
...
export const HistoricalReturnsScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
  ...
  const filters = ['all', 'monthly', 'quarterly', 'yearly'];
      ...
      >
        ...
        {loading ? (
          ...
          <View style={{ paddingHorizontal: 16 }}>
            ...
            {returnsDataData.map((item, index) => (
