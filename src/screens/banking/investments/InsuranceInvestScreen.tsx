...
const section0Data = Array.from({ length: 6 }, (_, idx) => ({
  ...
  description: `This is a detailed description for plan ${idx + 1}. It provides comprehensive information about features, pricing, availability, user ratings, and all other relevant details that premium users need to make informed decisions about their choice.`,
  icon: ['🏥', '💊', '🩺'][idx % 3],
  ...
  tags: ['Individual', 'Family', 'Senior'],
  features: ['Cashless', 'No Claim Bonus'],
...
const section1Data = Array.from({ length: 6 }, (_, idx) => ({
  id: String(idx + 1),
  title: `Plan ${idx + 1}`,
  subtitle: `Financial protection for family`,
  description: `This is a detailed description for plan ${idx + 1}. It provides comprehensive information about features, pricing, availability, user ratings, and all other relevant details that premium users need to make informed decisions about their choice.`,
  icon: ['🛡️', '👨‍👩‍👧', '💰'][idx % 3],
  value: `₹${(3000 + idx * 2000).toLocaleString()}`,
  rating: (3.5 + (idx % 15) / 10).toFixed(1),
  reviews: 50 + idx * 30,
  status: ['available', 'limited', 'popular', 'premium'][idx % 4],
  discount: Math.floor(Math.random() * 30 + 5),
  tags: ['Term', 'ULIP', 'Endowment'],
  features: ['Tax Benefit', 'High Cover'],
  gradient: ['#6366F1', '#8B5CF6'],
  date: `2025-01-${String(10 + idx).padStart(2, '0')}`,
  time: `${6 + idx % 12}:${idx % 2 === 0 ? '00' : '30'}`,
  amount: 3000 + idx * 2000,
  percentage: (5 + idx * 2.5).toFixed(1),
  details: {
    line1: 'Comprehensive detail line 1 with extended information about this particular item for users',
    line2: 'Additional context line 2 providing more insights and helpful information for decision making',
...
export const InsuranceInvestScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
            ...
            <>
              ...
              <Animated.View entering={FadeInDown.duration(400).delay(300)}>
                <View style={{ paddingHorizontal: 16, marginBottom: 8 }}>
                  <View style={styles.sectionHeader}>
                    <View>
                      <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>🏥 Health Insurance</Text>
                      <Text style={{ fontSize: 12, color: theme.colors.textSecondary }}>Compare plans</Text>
                    </View>
              ...
              <Animated.View entering={FadeInDown.duration(400).delay(380)}>
                <View style={{ paddingHorizontal: 16, marginBottom: 8 }}>
                  <View style={styles.sectionHeader}>
                    <View>
                      <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>🛡️ Life Insurance</Text>
                      <Text style={{ fontSize: 12, color: theme.colors.textSecondary }}>Explore plans</Text>
                    </View>
                    <TouchableOpacity onPress={() => haptics.light()}>
                      <Text style={{ fontSize: 14, fontWeight: '600', color: theme.colors.primary }}>View All</Text>
                    </TouchableOpacity>
              ...
              <Animated.View entering={FadeInDown.duration(400).delay(500)} style={{ paddingHorizontal: 16, marginBottom: 16 }}>
                ...
                <GlassCard
                  onPress={() => { haptics.medium(); handleAction("Compare Plans"); }}
                  style={{ marginBottom: 10, padding: 14 }}
                >
                  <View style={styles.spaceBetween}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 12 }}>
                        <Text style={{ fontSize: 15, fontWeight: '600', color: theme.colors.text }}>Compare Plans</Text>
