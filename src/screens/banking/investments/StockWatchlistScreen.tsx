...
const section0Data = Array.from({ length: 15 }, (_, idx) => ({
  id: String(idx + 1),
  title: `Stock ${idx + 1}`,
  subtitle: `Track stock performance`,
  description: `This is a detailed description for stock ${idx + 1}. It provides comprehensive information about features, pricing, availability, user ratings, and all other relevant details that premium users need to make informed decisions about their choice.`,
  icon: ['📈', '📊', '💹'][idx % 3],
  ...
  tags: ['NSE', 'BSE', 'Up', 'Down'],
  features: ['Nifty 50', 'Large Cap', 'Mid Cap'],
...
export const StockWatchlistScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
          ...
          {loading ? (
            ...
            <>
              ...
              <Animated.View entering={FadeInDown.duration(400).delay(300)}>
                <View style={{ paddingHorizontal: 16, marginBottom: 8 }}>
                  <View style={styles.sectionHeader}>
                    <View>
                      <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>📈 Your Watchlist</Text>
                      <Text style={{ fontSize: 12, color: theme.colors.textSecondary }}>Tracked stocks</Text>
                    </View>
              ...
              <Animated.View entering={FadeInDown.duration(400).delay(500)} style={{ paddingHorizontal: 16, marginBottom: 16 }}>
                ...
                <GlassCard
                  onPress={() => { haptics.medium(); handleAction("Add Stock"); }}
                  style={{ marginBottom: 10, padding: 14 }}
                >
                  <View style={styles.spaceBetween}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 12 }}>
                        <Text style={{ fontSize: 15, fontWeight: '600', color: theme.colors.text }}>Add Stock</Text>
