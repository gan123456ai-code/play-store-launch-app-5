...
const securityOptionsData = Array.from({ length: 8 }, (_, i) => ({
  id: String(i + 1),
  title: `Security Option ${i + 1}`,
  subtitle: `Manage your security settings`,
  description: `Security ${i + 1}. This includes comprehensive details about pricing, availability, features, amenities, and user reviews. Each item has been carefully curated to provide the best experience for our premium users.`,
  icon: ['🔒', '📱', '🔐', '👆'][i % 4],
  price: 0 + (i * 500),
  ...
  category: ['Authentication', 'Privacy', 'Alerts'][i % 3],
  amount: 0 + (i * 500),
  imageEmoji: ['🔒', '📱', '🔐', '👆'][i % 4],
  details: {
...
export const SecuritySettingsScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
  ...
  const filters = ['all', 'authentication', 'privacy', 'alerts'];
      ...
      >
        ...
        {loading ? (
          ...
          <View style={{ paddingHorizontal: 16 }}>
            ...
            {securityOptionsData.map((item, index) => (
