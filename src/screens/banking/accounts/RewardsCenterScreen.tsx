...
const rewardsData = Array.from({ length: 12 }, (_, i) => ({
  id: String(i + 1),
  title: `Reward ${i + 1}`,
  subtitle: `Redeem your reward points`,
  description: `Reward ${i + 1}. This includes comprehensive details about pricing, availability, features, amenities, and user reviews. Each item has been carefully curated to provide the best experience for our premium users.`,
  icon: ['🎁', '🎫', '✈️', '🏨', '💳'][i % 5],
  price: 500 + (i * 500),
  originalPrice: 1500 + (i * 500),
  rating: (3.5 + (i % 15) / 10).toFixed(1),
  reviews: 50 + i * 30,
  tags: ['Popular', 'New', 'Limited'],
  features: ['Travel', 'Shopping', 'Cashback'],
  ...
  category: ['Travel', 'Shopping', 'Cashback', 'Gift Cards'][i % 4],
  amount: 500 + (i * 500),
  imageEmoji: ['🎁', '🎫', '✈️', '🏨', '💳'][i % 5],
  details: {
...
export const RewardsCenterScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
  ...
  const filters = ['all', 'travel', 'shopping', 'cashback', 'gift cards'];
