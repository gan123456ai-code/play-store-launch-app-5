...
const linkedAccountsData = Array.from({ length: 5 }, (_, i) => ({
  id: String(i + 1),
  title: `Account ${i + 1}`,
  subtitle: `Linked bank account`,
  description: `Account ${i + 1}. This includes comprehensive details about pricing, availability, features, amenities, and user reviews. Each item has been carefully curated to provide the best experience for our premium users.`,
  icon: ['🏦', '🏧', '🏛️'][i % 3],
  price: 0 + (i * 500),
  ...
  category: ['Savings', 'Current', 'Salary'][i % 3],
  amount: 0 + (i * 500),
  imageEmoji: ['🏦', '🏧', '🏛️'][i % 3],
  details: {
...
export const LinkedAccountsScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
  ...
  const filters = ['all', 'savings', 'current', 'salary'];
      ...
      >
        ...
        {loading ? (
          ...
          <View style={{ paddingHorizontal: 16 }}>
            ...
            {linkedAccountsData.map((item, index) => (
