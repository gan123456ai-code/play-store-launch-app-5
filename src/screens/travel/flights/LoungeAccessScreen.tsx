...
export const LoungeAccessScreen: React.FC<{ navigation: any; route: any }> = ({ navigation, route }) => {
  ...
  const items = Array.from({ length: 12 }, (_, i) => ({
    ...
    description: 'This is a detailed description for lounge access item ' + (i + 1) + '. It contains all the relevant information that users need to make an informed decision about this particular option.',
