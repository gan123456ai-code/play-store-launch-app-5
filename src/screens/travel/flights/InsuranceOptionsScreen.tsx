...
export const InsuranceOptionsScreen: React.FC<{ navigation: any; route: any }> = ({ navigation, route }) => {
  ...
  const items = Array.from({ length: 12 }, (_, i) => ({
    id: String(i),
    title: 'Insurance Options Item ' + (i + 1),
    ...
    description: 'This is a detailed description for insurance options item ' + (i + 1) + '. It contains all the relevant information that users need to make an informed decision about this particular option.',
