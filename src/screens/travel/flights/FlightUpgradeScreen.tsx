...
const upgradeClassOptions = ['Premium Economy', 'Business', 'First Class'];



const section0Data = Array.from({ length: 4 }, (_, idx) => ({
  id: String(idx + 1),
  title: `Upgrade Package ${idx + 1}`,
  subtitle: `Premium upgrade option`,
  description: `This is a detailed description for upgrade package ${idx + 1}. It provides comprehensive information about features, pricing, availability, user ratings, and all other relevant details that premium users need to make informed decisions about their choice.`,
  icon: ['👑', '💎', '🌟'][idx % 3],
  ...
  features: ['Priority', 'Lounge', 'Meals'],
...
export const FlightUpgradeScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
  ...
  const [upgradeClass, setUpgradeClass] = useState('Business');
        ...
        >
          ...
          {loading ? (
            ...
            <>
                ...
                <GlassCard style={{ marginHorizontal: 16, marginBottom: 16, padding: 16 }} animated={false}>
                  ...
                  <View style={[styles.infoRow, { borderBottomColor: theme.colors.divider }]}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 10 }}>
                        ...
                        <Text style={[styles.infoValue, { color: theme.colors.text }]}>AI-302 • DEL → BOM</Text>
                      </View>
                    </View>
                  ...
                  <View style={[styles.infoRow, { borderBottomColor: theme.colors.divider }]}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 10 }}>
                        <Text style={[styles.infoLabel, { color: theme.colors.textSecondary }]}>Current Class</Text>
                        <Text style={[styles.infoValue, { color: theme.colors.text }]}>Economy</Text>
                      </View>
                    </View>
                    <TouchableOpacity onPress={() => { haptics.light(); }}>
                      <Ionicons name="chevron-forward" size={18} color={theme.colors.textTertiary} />
                  ...
                  <View style={[styles.infoRow, { borderBottomColor: theme.colors.divider }]}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 10 }}>
                        <Text style={[styles.infoLabel, { color: theme.colors.textSecondary }]}>Travel Date</Text>
                        <Text style={[styles.infoValue, { color: theme.colors.text }]}>25 Dec 2024</Text>
                      </View>
                    </View>
                    <TouchableOpacity onPress={() => { haptics.light(); }}>
                      <Ionicons name="chevron-forward" size={18} color={theme.colors.textTertiary} />
                ...
                <GlassCard style={{ marginHorizontal: 16, marginBottom: 16, padding: 16 }} animated={false}>
                  ...
                  <View style={[styles.infoRow, { borderBottomColor: theme.colors.divider }]}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 10 }}>
                        ...
                        <Text style={[styles.infoValue, { color: theme.colors.text }]}>Fully flat bed with privacy screen</Text>
                      </View>
                    </View>
                    <TouchableOpacity onPress={() => { haptics.light(); }}>
                      <Ionicons name="chevron-forward" size={18} color={theme.colors.textTertiary} />
                  ...
                  <View style={[styles.infoRow, { borderBottomColor: theme.colors.divider }]}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 10 }}>
                        <Text style={[styles.infoLabel, { color: theme.colors.textSecondary }]}>Meals</Text>
                        <Text style={[styles.infoValue, { color: theme.colors.text }]}>Multi-course gourmet dining</Text>
                      </View>
                    </View>
                    <TouchableOpacity onPress={() => { haptics.light(); }}>
                      <Ionicons name="chevron-forward" size={18} color={theme.colors.textTertiary} />
                  ...
                  <View style={[styles.infoRow, { borderBottomColor: theme.colors.divider }]}>
                    <View style={styles.row}>
                      <View style={[styles.infoIcon, { backgroundColor: '#06B6D4' + '15' }]}>
                        <Text style={{ fontSize: 16 }}>🧳</Text>
                      </View>
                      <View style={{ marginLeft: 10 }}>
                        <Text style={[styles.infoLabel, { color: theme.colors.textSecondary }]}>Baggage</Text>
                        <Text style={[styles.infoValue, { color: theme.colors.text }]}>40kg check-in + 10kg cabin</Text>
                      </View>
                    </View>
                    <TouchableOpacity onPress={() => { haptics.light(); }}>
                      <Ionicons name="chevron-forward" size={18} color={theme.colors.textTertiary} />
                  ...
                  <View style={[styles.infoRow, { borderBottomColor: theme.colors.divider }]}>
                    <View style={styles.row}>
                      <View style={[styles.infoIcon, { backgroundColor: '#D97706' + '15' }]}>
                        <Text style={{ fontSize: 16 }}>🏢</Text>
                      </View>
                      <View style={{ marginLeft: 10 }}>
                        <Text style={[styles.infoLabel, { color: theme.colors.textSecondary }]}>Lounge</Text>
                        <Text style={[styles.infoValue, { color: theme.colors.text }]}>Priority lounge access</Text>
                      </View>
                    </View>
                    <TouchableOpacity onPress={() => { haptics.light(); }}>
                      <Ionicons name="chevron-forward" size={18} color={theme.colors.textTertiary} />
              ...
              <Animated.View entering={FadeInDown.duration(400).delay(200)}>
                <GlassCard style={{ marginHorizontal: 16, marginBottom: 16, padding: 16 }} animated={false}>
                  ...
                  <View style={styles.formGroup}>
                    <Text style={[styles.formLabel, { color: theme.colors.textSecondary }]}>Upgrade To</Text>
                    
                    <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{ marginBottom: 8 }}>
                      {upgradeClassOptions.map((opt) => (
                        <TouchableOpacity
                          key={opt}
                          onPress={() => { haptics.selection(); setUpgradeClass(opt); }}
                          style={[styles.chip, {
                            backgroundColor: upgradeClass === opt ? theme.colors.primary : 'transparent',
                            borderColor: upgradeClass === opt ? theme.colors.primary : theme.colors.border,
                          }]}
                        >
                          <Text style={[styles.chipText, { color: upgradeClass === opt ? '#FFFFFF' : theme.colors.textSecondary }]}>{opt}</Text>
                        </TouchableOpacity>
                      ))}
                    </ScrollView>
              ...
              {/* Available Packages Items */}
              <Animated.View entering={FadeInDown.duration(400).delay(300)}>
                <View style={{ paddingHorizontal: 16, marginBottom: 8 }}>
                  <View style={styles.sectionHeader}>
                    <View>
                      <Text style={[styles.sectionTitle, { color: theme.colors.text }]}>👑 Available Packages</Text>
                      <Text style={{ fontSize: 12, color: theme.colors.textSecondary }}>Choose your upgrade</Text>
                    </View>
                    <TouchableOpacity onPress={() => haptics.light()}>
                    ...
                    <Animated.View key={item.id} entering={FadeInDown.duration(300).delay(idx * 40)}>
                      <GlassCard
                        onPress={() => {
                          ...
                          navigation.navigate('FlightPayment', { item });
                        }}
                        ...
                        {expandedItem === item.id && (
                          <Animated.View entering={FadeInDown.duration(300)} style={{ marginTop: 12, borderTopWidth: 1, borderTopColor: theme.colors.divider, paddingTop: 12 }}>
                            ...
                            <View style={[styles.spaceBetween, { marginTop: 10 }]}>
                              ...
                              <AnimatedButton
                                title="Select"
                                onPress={() => { haptics.medium(); navigation.navigate('FlightPayment', { item }); }}
                                variant="primary"
                                size="small"
                              />
                            </View>
              ...
              <Animated.View entering={FadeInDown.duration(400).delay(500)} style={{ paddingHorizontal: 16, marginBottom: 16 }}>
                ...
                <GlassCard
                  onPress={() => { haptics.medium(); navigation.navigate('FlightPayment'); }}
                  style={{ marginBottom: 10, padding: 14 }}
                >
                  <View style={styles.spaceBetween}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 12 }}>
                        <Text style={{ fontSize: 15, fontWeight: '600', color: theme.colors.text }}>Pay ₹12,500 for Upgrade</Text>
                ...
                <GlassCard
                  onPress={() => { haptics.medium(); handleAction("Use Miles for Upgrade"); }}
                  style={{ marginBottom: 10, padding: 14 }}
                >
                  <View style={styles.spaceBetween}>
                    <View style={styles.row}>
                      ...
                      <View style={{ marginLeft: 12 }}>
                        <Text style={{ fontSize: 15, fontWeight: '600', color: theme.colors.text }}>Use Miles for Upgrade</Text>
                        <Text style={{ fontSize: 12, color: theme.colors.textSecondary }}></Text>
                      </View>
                    </View>
                    <Ionicons name="chevron-forward" size={20} color={theme.colors.textTertiary} />
