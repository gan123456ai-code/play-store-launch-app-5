...
const reviewsData = Array.from({ length: 20 }, (_, i) => ({
  ...
  subtitle: `Great stay! Would definitely recommend`,
  description: `Detailed review ${i + 1}. This includes comprehensive details about pricing, availability, features, amenities, and user reviews. Each item has been carefully curated to provide the best experience for our premium users.`,
  icon: ['⭐', '👍', '💯', '🏆'][i % 4],
  price: 0 + (i * 500),
  ...
  features: ['Clean', 'Great Location', 'Friendly Staff'],
  ...
  category: ['Business', 'Leisure', 'Family', 'Solo'][i % 4],
  amount: 0 + (i * 500),
  imageEmoji: ['⭐', '👍', '💯', '🏆'][i % 4],
  details: {
...
export const HotelReviewsScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
  ...
  const filters = ['all', 'business', 'leisure', 'family', 'solo'];
