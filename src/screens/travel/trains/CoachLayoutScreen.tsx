...
const coachesData = Array.from({ length: 8 }, (_, i) => ({
  id: String(i + 1),
  title: `Coach ${i + 1}`,
  subtitle: `Berth layout and availability`,
  description: `Coach ${i + 1}. This includes comprehensive details about pricing, availability, features, amenities, and user reviews. Each item has been carefully curated to provide the best experience for our premium users.`,
  icon: ['🚃', '💺'][i % 2],
  price: 0 + (i * 500),
  ...
  reviews: 50 + i * 30,
  tags: ['AC', 'Sleeper'],
  features: ['Lower Available', 'Upper Available'],
...
export const CoachLayoutScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
