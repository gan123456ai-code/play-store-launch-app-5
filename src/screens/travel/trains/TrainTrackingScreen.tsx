...
const stopsData = Array.from({ length: 12 }, (_, i) => ({
  id: String(i + 1),
  title: `Station ${i + 1}`,
  subtitle: `Scheduled stop`,
  description: `Station ${i + 1}. This includes comprehensive details about pricing, availability, features, amenities, and user reviews. Each item has been carefully curated to provide the best experience for our premium users.`,
  icon: ['🚉', '📍'][i % 2],
  price: 0 + (i * 500),
  originalPrice: 1000 + (i * 500),
  rating: (3.5 + (i % 15) / 10).toFixed(1),
  reviews: 50 + i * 30,
  tags: ['Passed', 'Current', 'Upcoming'],
  features: ['Platform 1', 'Halt 2 min'],
...
export const TrainTrackingScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
