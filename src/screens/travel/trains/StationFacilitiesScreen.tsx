...
const facilitiesData = Array.from({ length: 12 }, (_, i) => ({
  id: String(i + 1),
  title: `Facility ${i + 1}`,
  subtitle: `Available at the station`,
  description: `Facility ${i + 1}. This includes comprehensive details about pricing, availability, features, amenities, and user reviews. Each item has been carefully curated to provide the best experience for our premium users.`,
  icon: ['🍔', '🚻', '💊', '📶', '🅿️', '🛒'][i % 6],
  price: 0 + (i * 500),
  ...
  category: ['Food', 'Convenience', 'Transport'][i % 3],
  amount: 0 + (i * 500),
  imageEmoji: ['🍔', '🚻', '💊', '📶', '🅿️', '🛒'][i % 6],
  details: {
...
export const StationFacilitiesScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
  ...
  const filters = ['all', 'food', 'convenience', 'transport'];
