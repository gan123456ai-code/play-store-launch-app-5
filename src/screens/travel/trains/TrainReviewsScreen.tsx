...
const trainReviewsData = Array.from({ length: 15 }, (_, i) => ({
  id: String(i + 1),
  title: `Review by Passenger ${i + 1}`,
  subtitle: `Comfortable journey, good food`,
  description: `Review ${i + 1}. This includes comprehensive details about pricing, availability, features, amenities, and user reviews. Each item has been carefully curated to provide the best experience for our premium users.`,
  icon: ['⭐', '👍', '💯'][i % 3],
  price: 0 + (i * 500),
  originalPrice: 1000 + (i * 500),
  rating: (3.5 + (i % 15) / 10).toFixed(1),
  reviews: 50 + i * 30,
  tags: ['Excellent', 'Good', 'Average'],
  features: ['Clean', 'On Time', 'Good Food'],
...
export const TrainReviewsScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
      ...
      >
        ...
        {loading ? (
          ...
          <View style={{ paddingHorizontal: 16 }}>
            ...
            {trainReviewsData.map((item, index) => (
