...
const scheduleData = Array.from({ length: 10 }, (_, i) => ({
  ...
  description: `Scheduled train ${i + 1}. This includes comprehensive details about pricing, availability, features, amenities, and user reviews. Each item has been carefully curated to provide the best experience for our premium users.`,
  icon: ['🚂', '📅'][i % 2],
  price: 350 + (i * 500),
  originalPrice: 1350 + (i * 500),
...
export const TrainScheduleScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
  ...
  const filters = ['all', 'express', 'mail'];
