...
const upcomingData = Array.from({ length: 5 }, (_, i) => ({
  id: String(i + 1),
  title: `Trip ${i + 1}`,
  subtitle: `Your upcoming adventure`,
  description: `Upcoming trip ${i + 1}. This includes comprehensive details about pricing, availability, features, amenities, and user reviews. Each item has been carefully curated to provide the best experience for our premium users.`,
  icon: ['✈️', '🏨', '🚂'][i % 3],
  price: 3000 + (i * 500),
  originalPrice: 4000 + (i * 500),
  rating: (3.5 + (i % 15) / 10).toFixed(1),
  reviews: 50 + i * 30,
  tags: ['Confirmed'],
  features: ['E-Ticket', 'Insured'],
  ...
  category: ['Flights', 'Hotels', 'Trains'][i % 3],
  amount: 3000 + (i * 500),
  imageEmoji: ['✈️', '🏨', '🚂'][i % 3],
  details: {
...
export const UpcomingTripsScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
  ...
  const filters = ['all', 'flights', 'hotels', 'trains'];
      ...
      >
        ...
        <Animated.View entering={FadeInDown.duration(600).delay(200)}>
          <View style={styles.sectionHeader}>
            <Text style={[styles.sectionTitle, { color: theme.colors.text, fontSize: 18 }]}>🔥 All Upcoming</Text>
          </View>
          {loading ? (
