...
const completedData = Array.from({ length: 10 }, (_, i) => ({
  id: String(i + 1),
  title: `Trip ${i + 1}`,
  subtitle: `Past completed trip`,
  description: `Completed trip ${i + 1}. This includes comprehensive details about pricing, availability, features, amenities, and user reviews. Each item has been carefully curated to provide the best experience for our premium users.`,
  icon: ['✈️', '🏨', '🚂'][i % 3],
  price: 2000 + (i * 500),
...
export const CompletedTripsScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
