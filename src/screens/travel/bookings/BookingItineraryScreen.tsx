...
const itineraryData = Array.from({ length: 8 }, (_, i) => ({
  id: String(i + 1),
  title: `Day ${i + 1}`,
  subtitle: `Planned activity`,
  description: `Itinerary item ${i + 1}. This includes comprehensive details about pricing, availability, features, amenities, and user reviews. Each item has been carefully curated to provide the best experience for our premium users.`,
  icon: ['✈️', '🏨', '🍽️', '🎭', '📸'][i % 5],
  price: 0 + (i * 500),
  ...
  category: ['Travel', 'Stay', 'Activity'][i % 3],
  amount: 0 + (i * 500),
  imageEmoji: ['✈️', '🏨', '🍽️', '🎭', '📸'][i % 5],
  details: {
...
export const BookingItineraryScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
  ...
  const filters = ['all', 'travel', 'stay', 'activity'];
