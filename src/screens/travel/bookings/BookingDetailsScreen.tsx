...
const timelineItems = [
  { id: '0', title: 'Booking Confirmed', subtitle: '20 Dec, 10:30 AM', icon: '✅', color: '#10B981', value: '' },
  { id: '1', title: 'Payment Received', subtitle: '20 Dec, 10:30 AM', icon: '💳', color: '#3B82F6', value: '' },
  { id: '2', title: 'E-Ticket Generated', subtitle: '20 Dec, 10:31 AM', icon: '🎫', color: '#8B5CF6', value: '' },
];


export const BookingDetailsScreen: React.FC<{ navigation: any; route?: any }> = ({ navigation, route }) => {
  ...
  const tabs = [{ id: 'timeline', label: 'Booking Timeline' }];
      ...
      >
        ...
        <Animated.View entering={FadeInDown.duration(600).delay(200)}>
          <View style={styles.sectionHeader}>
            <View>
              <Text style={[styles.sectionTitle, { color: theme.colors.text, fontSize: 18 }]}>📌 Booking Timeline</Text>
          ...
          <View style={{ paddingHorizontal: 16 }}>
            {timelineItems.map((item, idx) => (
              <Animated.View key={item.id} entering={FadeInRight.duration(400).delay(idx * 60)}>
                <GlassCard
                  onPress={() => { haptics.medium(); navigation.navigate('BookingItinerary'); }}
